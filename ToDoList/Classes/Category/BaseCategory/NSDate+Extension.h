...
#define kDateFormatterStye_YMH @"yyyy-MM-dd"
#define kDateFormatterStye_YMHMD @"yyyy-MM-dd HH:mm:ss"

@interface NSDate (Extension)
+ (NSString *)convertTime:(NSString *)timestamp;
...
+(NSString *)getCurrentMonthDayHH:(NSTimeInterval)time;

+(NSString *)getCurrentYearMonthDay:(NSTimeInterval)time;
...
+ (NSString *)getCurrentTimestampWithout1000;
