...
- (void)setView{
    ...
    _numberText=[[UITextField alloc]initWithFrame:CGRectMake(btnWidth+8, 0, viewWidth-btnWidth*2-16, btnWidth)];
    if (_baseNum.length!=0) {
        _numberText.text=_baseNum;
    }else{
        _numberText.text=@"0";
    }
    _numberText.backgroundColor = kRGB_COLOR(248,248,248) ;
    ...
    _addBtn=[[UIButton alloc]initWithFrame:CGRectMake(CGRectGetMaxX(_numberText.frame)+8, 0, btnWidth, btnWidth)];
