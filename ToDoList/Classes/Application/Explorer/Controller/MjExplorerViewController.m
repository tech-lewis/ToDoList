...
@interface MjExplorerViewController ()
/**导航栏标题（默认缓存目录）*/
...
@implementation MjExplorerViewController
    ...
    if (_cacheTable == nil) {
        ...
        _cacheTable.itemClick = ^(NSIndexPath *indexPath) {
            ...
            if (TFY_CacheFileTypeUnknow == type) {
                ...
                MjExplorerViewController *cacheVC = [MjExplorerViewController new];
