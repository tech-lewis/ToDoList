...
- (void)touchesBegan:(NSSet *)touches withEvent:(UIEvent *)event
{
    ...
    CGPoint point = [touch locationInView:self];
        ...
        {
            self.item.itemNote = self.contentCellController.noteTextView.text;
            // 闭合这个视图的imageView
...
- (void)setItem:(BiDToDoItem *)item
{
    ...
    {
        self.contentCellController.noteTextView.text = item.itemNote;
        self.contentCellController.subjectLabel.text = item.itemName;
        self.contentCellController.planDateLabel.text = [NSDateFormatter localizedStringFromDate:item.planDate dateStyle:NSDateFormatterLongStyle timeStyle:NSDateFormatterNoStyle];
        self.contentCellController.creationDateLabel.text = [NSDateFormatter localizedStringFromDate:item.creationDate dateStyle:NSDateFormatterLongStyle timeStyle:NSDateFormatterNoStyle];
    }
}
